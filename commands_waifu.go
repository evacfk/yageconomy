...
var (
	WaifuCmdTop = &commands.YAGCommand{
		...
		RunFunc: func(parsed *dcmd.Data) (interface{}, error) {
			...
			return paginatedmessages.NewPaginatedMessage(parsed.GuildData.GS.ID, parsed.GuildData.CS.ID, parsed.Args[0].Int(), 0, func(p *paginatedmessages.PaginatedMessage, newPage int) (*discordgo.MessageEmbed, error) {
...
func ListWaifuItems(guildID, channelID int64, u *discordgo.User, currentMoney int64, currencySymbol string) (*discordgo.MessageEmbed, error) {
	...
	return paginatedmessages.CreatePaginatedResponse(guildID, channelID, 1, 0, func(p *paginatedmessages.PaginatedMessage, newPage int) (*discordgo.MessageEmbed, error) {
